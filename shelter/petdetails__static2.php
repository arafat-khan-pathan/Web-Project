...
<body>
    ...
    <nav class="navbar">
        <div class="container nav-flex">
            ...
            <div class="nav-links">
                ...
                <div class="user-info">
                    <a href="profile.html" id="userNameDisplay" class="hov active">Loyal Friends Rescue</a>
    ...
    <main class="container details-wrapper">
        <a href="shelterprofile.html" class="back-link">
            <i data-lucide="arrow-left"></i> Back to Browse
        </a>

        <div class="details-card">
            <div class="pet-gallery">
                <img src="https://images.unsplash.com/photo-1633722715463-d30f4f325e24?auto=format&fit=crop&q=80&w=800"
                    alt="Max">
            </div>
            ...
            <div class="pet-info">
                ...
                <div class="info-section">
                    ...
                    <p>Max is the definition of a 'Good Boy'. He was rescued from a situation where he had too much
                        energy for a small apartment. He loves tennis balls, swimming, and is incredibly gentle with
                        children. He knows basic commands like 'sit', 'stay', and 'paw'.</p>
                </div>
                ...
                <div class="medical-grid">
                    ...
                    <div class="medical-box">
                        ...
                        <p style="font-size: 0.85rem; margin-top: 0.5rem; color: var(--text-muted);">Last comprehensive
                            vet check performed on Jan 15, 2024.</p>
                    </div>
                </div>

                <div class="info-section">
                    <h3><i data-lucide="clipboard-list"></i> Active Log</h3>
                ...
                <!-- <div class="action-area">
                    <a href="#" class="btn-large btn-sponsor">Sponsor Info</a>
                    <a href="apply.html" class="btn-large btn-adopt-now">Apply to Adopt</a>
                </div> -->
                ...
                <div class="action-area">
                    <a href="messages.html" class="btn-large btn-chat">
                        <i data-lucide="message-square"></i> Chat with Adopter
                    </a>
                </div>
    ...
    <script>
        ...
        function addMedicalLog(petId) {
            const dateInput = document.getElementById('newLogDate');
            const noteInput = document.getElementById('newLogNote');

            if (!noteInput.value.trim()) {
                alert("Please enter a note for the medical update.");
                return;
            }

            // Add to database
            petDatabase[petId].medicalLog.unshift({
