...
<head>
    ...
    <link rel="stylesheet" href="../guidelines__.css">
    <link rel="stylesheet" href="../index.css">
    ...
    <nav class="navbar">
        <div class="container nav-flex">
            ...
            <div class="nav-links">
                ...
                <a href="messages.html" class="active">Message</a>

                <!-- <a href="guidelines__.html">Guidelines</a> -->
                <div class="user-info">
                    <a href="shelterprofile.html" id="userNameDisplay" class="hov ">Loyal Friends Rescue
</a>
